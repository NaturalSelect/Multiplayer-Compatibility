...
namespace Multiplayer.Compat
{
    ...
    class GD3
    {
        ...
        // 辅助方法：安全地注册同步方法
        private static void TryRegister(string methodPath)
        {
            try
            {
        ...
        private static void TryRegisterLambdaMethod(string typeName, string parentMethod, int lambdaOrdinal, bool debugOnly = false)
        {
            try
            {
